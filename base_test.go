...
func TestBase(t *testing.T) {
	...
	TestType(t, Decimal(18, 4), decimal.New(-42000, -4), "SELECT toDecimal64(-4.2, 4)")
	TestType(t, Map(String, String), map[string]string{"key": "value", "key2": "value2"}, "SELECT map('key', 'value', 'key2', 'value2')")
	TestType(t, MapAny(String, String), map[any]any{"key": "value", "key2": "value2"}, "SELECT map('key', 'value', 'key2', 'value2')")
